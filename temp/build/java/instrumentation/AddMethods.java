...
package build.java.instrumentation;
...
public class AddMethods {
    public static void main(String[] args) throws Exception {
        ...
        addPropertiesGettersSetters(clazz, com.mysql.cj.conf.PropertyDefinitions.PROPERTY_NAME_TO_PROPERTY_DEFINITION.values());
    ...
    private static void addPropertiesGettersSetters(CtClass clazz, Collection<PropertyDefinition<?>> propertyDefinitions) throws Exception {
        for (PropertyDefinition<?> def : propertyDefinitions) {
            ...
            } else if (def instanceof com.mysql.cj.conf.LongPropertyDefinition) {
