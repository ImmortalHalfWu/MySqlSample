...
public class PropertyDefinitions {
    ...
    static {
        PropertyDefinition<?>[] pdefs = new PropertyDefinition<?>[] {
                new com.mysql.cj.conf.BooleanPropertyDefinition(PNAME_paranoid, NO_ALIAS, DEFAULT_VALUE_FALSE, RUNTIME_NOT_MODIFIABLE,
                ...
                new StringPropertyDefinition(PNAME_profilerEventHandler, NO_ALIAS, "LoggingProfilerEventHandler", RUNTIME_MODIFIABLE,
                ...
                new StringPropertyDefinition(PNAME_socketFactory, NO_ALIAS, "StandardSocketFactory", RUNTIME_MODIFIABLE,
