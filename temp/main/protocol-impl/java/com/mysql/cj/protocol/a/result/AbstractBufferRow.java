...
public abstract class AbstractBufferRow extends AbstractResultsetRow {
    ...
    /**
     * The last-requested index, used as an optimization, if you ask for the same index, we won't seek to selectFromSQL it. If you ask for an index that is greater
