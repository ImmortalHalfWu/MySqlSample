 ...
 * 
 * The driver will not pass in a Connection init when calling init(), but it will pass in the Properties, otherwise it acts like a normal Extension.
 * 
 * One init of a strategy *per* JDBC connection init will be created. If you need singleton-like behavior, you're on your own to provide it.
 */
